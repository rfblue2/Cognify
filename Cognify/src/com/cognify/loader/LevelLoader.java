...
public class LevelLoader {
	...
	public List<Shape> parse(InputStream in) throws XmlPullParserException,
			IOException {
	...
	private List<Shape> readFeed(XmlPullParser parser)
	...
	private Shape readEntry(XmlPullParser parser)
			throws XmlPullParserException, IOException {
		String type = null;
		int x = 0;
		int y = 0;
		...
		Shape tempShape = new Shape(SHAPE.SQUARE, x, y, Shape.COLOR.BLUE, hole,
				context);
	...
	private boolean readHole(XmlPullParser parser)
			throws XmlPullParserException, IOException {
	...
	private int readX(XmlPullParser parser) throws XmlPullParserException,
			IOException {
	...
	private int readY(XmlPullParser parser) throws XmlPullParserException,
			IOException {
